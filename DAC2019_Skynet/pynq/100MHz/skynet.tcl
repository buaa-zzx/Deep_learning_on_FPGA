...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net SkyNet_0_m_axi_INPUT_r [get_bd_intf_pins SkyNet_0/m_axi_INPUT_r] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net SkyNet_0_m_axi_OUTPUT_r [get_bd_intf_pins SkyNet_0/m_axi_OUTPUT_r] [get_bd_intf_pins smartconnect_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_2_M00_AXI [get_bd_intf_pins SkyNet_0/s_axi_AXILiteS] [get_bd_intf_pins smartconnect_2/M00_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins smartconnect_2/S01_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]

  # Create port connections
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins SkyNet_0/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins smartconnect_2/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins SkyNet_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_2/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SkyNet_0/Data_m_axi_INPUT_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces SkyNet_0/Data_m_axi_INPUT_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SkyNet_0/Data_m_axi_OUTPUT_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces SkyNet_0/Data_m_axi_OUTPUT_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SkyNet_0/s_axi_AXILiteS/Reg] SEG_SkyNet_0_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SkyNet_0/Data_m_axi_INPUT_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs SkyNet_0/Data_m_axi_INPUT_r/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SkyNet_0/Data_m_axi_OUTPUT_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs SkyNet_0/Data_m_axi_OUTPUT_r/SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM]
